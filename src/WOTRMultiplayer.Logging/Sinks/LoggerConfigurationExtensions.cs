...
namespace WOTRMultiplayer.Logging.Sinks
{
    public static class LoggerConfigurationExtensions
    {
        ...
        {
            var consoleTheme = SystemConsoleTheme.Literate;
            ...
            return sinkConfiguration.Sink(new DebugConsoleSink(output, consoleTheme, formatter, syncRoot), restrictedToMinimumLevel, levelSwitch);
        }
    }
}
